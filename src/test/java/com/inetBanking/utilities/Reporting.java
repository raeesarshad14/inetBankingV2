...
public class Reporting extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		extent.setSystemInfo("Host name","localhost"); // we have to mantion computer name in LocalHost place.
		extent.setSystemInfo("Environemnt","QA");
		extent.setSystemInfo("user","Raees");
	...
	public void onTestFailure(ITestResult tr)
	{
		...
		String screenshotPath=System.getProperty("C:\\Users\\raees.arshad\\eclipse-workspace\\inetBankingV2\\Screenshots\\")+tr.getName()+".png";
